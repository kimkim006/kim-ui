...
<div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row>
        ...
        <el-table-column v-if="showSecCol" label="键值" width="120px" align="center" >
            <template slot-scope="scope"><span>{{scope.row.code}}</span></template>
        </el-table-column>
        
        <el-table-column v-if="showSecCol" label="解释" width="180px" align="center" >
        ...
        <div class="el-dialog-panel">
            <el-form :model="form" :rules="rules" ref="form" label-width="80px" class="form-body-u">
            	...
            	<div v-else style="display: table">
            		<el-form-item label="解释" prop="name" required style="float: left;width: 270px;">
	                   <el-input v-model="form.name" placeholder="请输入解释"></el-input>
	                </el-form-item>
	                <el-form-item label="键值" prop="code" required style="float: left;width: 270px;">
